...
> **Codex Agent CLI** handoff: [`codex-handoff.md`](codex-handoff.md) · 한 줄 시작: `codex exec "$(cat docs/codex-resume.prompt)"`  
...
| 다학원·초대            | `AcademyInvite`·SMTP 메일·**`/auth/sign-in`** 복귀·**`/invite/accept`** 수락                        |
